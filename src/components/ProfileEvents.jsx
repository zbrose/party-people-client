    ...
    return ( 
        <>
            ...
            <Tabs id="uncontrolled-tab-example" className="mb-3 flex-tab" defaultActiveKey='Hosting'>
                ...
                <Tab eventKey="Hosting" title="Hosting"><div className='flex-box tab-style'>{hostingList}</div></Tab>
                <Tab eventKey="Attending" title="Attending" ><div className='flex-box tab-style'>{attendingList}</div></Tab>
            </Tabs>    
