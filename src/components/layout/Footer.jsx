    ...
    return ( 
        ...
        <div className='footer BebasNeue' id="footer">
            ...
            <div>
                ...
                <h3 className='light-blue' style={{width: '8rem', margin: '5px'}}>Meet The Developers: </h3>
            
            <Nav defaultActiveKey="/home" className="flex-column">
                <h3 className='light-blue'>Triston J. Palacios</h3>
            ...
            <Nav defaultActiveKey="/home" className="flex-column">
                 <h3 className='light-blue'>Bryan Nguyen</h3>
            ...
            <Nav defaultActiveKey="/home" className="flex-column">
                <h3 className='light-blue'>Grace Sung</h3>
            ...
            <Nav defaultActiveKey="/home" className="flex-column">
                <h3 className='light-blue'>Zach Brose</h3>
