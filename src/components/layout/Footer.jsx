    ...
    return ( 
        ...
        <div className='footer BebasNeue'>
            ...
            <Nav defaultActiveKey="/home" className="flex-column">
                ...
                <Nav.Link className='pink-font' href="https://www.linkedin.com/in/tristonpalacios/"  target="_blank" eventKey="LinkedIn-1">LinkedIn</Nav.Link>
                <Nav.Link target="_blank" className='pink-font' href="https://github.com/tristonpalacios"
                eventKey="github-1">GitHub</Nav.Link>
            </Nav>
            <Nav defaultActiveKey="/home" className="flex-column">
                 <h3>Bryan Nguyen</h3>
                 <Nav.Link className='pink-font'  target="_blank" href="https://www.linkedin.com/in/brnguy/" eventKey="LinkedIn-2">LinkedIn</Nav.Link>
            ...
            <Nav target="_blank"  defaultActiveKey="/home" className="flex-column">
                <h3>Zach Brose</h3>
